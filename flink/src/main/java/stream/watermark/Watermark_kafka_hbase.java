...
//        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,"flink1:9092,flink2:9092,flink3:9092");
        ...
        String topic = "transferBill1";

        FlinkKafkaConsumer<String> consumer011 = new FlinkKafkaConsumer<>(topic, new SimpleStringSchema(), properties);
        ...
        //分组，聚合
        DataStream<List<Long>> window = waterMarkStream.keyBy(0)//这里可以用表名作为key
                ...
                .apply(new WindowFunction<Tuple2<String, Long>, List<Long>, Tuple, TimeWindow>() {
                    /**
                     ...
                     */
                    @Override
                    public void apply(Tuple tuple, TimeWindow window, Iterable<Tuple2<String, Long>> input, Collector<List<Long>> out) throws Exception {
