 ...
 * @Description:
 **/
public class ADS_ReceiptBillEntrySum1_IPF extends CustomTableInputFormat<DWS_ReceiptBillEntrySumVo> {
    ...
    protected DWS_ReceiptBillEntrySumVo mapResultToTuple(Result r) {
        ...
        for (Cell cell:r.listCells()){
            ...
            if ("projectID".equals(column)){
                ...
                receiptBillEntrySumVo.setReceiverID(Bytes.toString(CellUtil.cloneValue(cell)));
