 ...
 * @Description:
 **/
public class ADS_ReceiptBillEntrySum3_OPF implements OutputFormat<ADS_ReceiptBillEntrySum3Vo> {
    private static final Logger logger = LoggerFactory.getLogger(ADS_ReceiptBillEntrySum3_OPF.class);
    ...
    public void open(int i, int i1) throws IOException {
        ...
        if (!admin.tableExists(TableName.valueOf("ads_owner_cloud:ads_receiptBillEntrySum3"))){
            try {
            ...
            createTable("ads_owner_cloud:ads_receiptBillEntrySum3","cf");
        }

        table = conn.getTable(TableName.valueOf("ads_owner_cloud:ads_receiptBillEntrySum3"));
    }

    @Override
    public void writeRecord(ADS_ReceiptBillEntrySum3Vo ads_receiptBillEntrySumVo) throws IOException {
        ...
        String rowkey = RowKeyUtil.generateShortUuid8(MD5Utils.hash(moneydefineID))+businessType+tranDate;
